  ...
  return (
    <header className="bg-white shadow-md fixed w-full z-50 transition-all duration-300">
      <nav className="container mx-auto px-6 py-2 md:py-4">
        ...
        <div className="text-2xl font-bold text-gray-800 py-2 md:py-0 md:mb-0 transition-all duration-300 hover:text-gray-600 w-full text-center">TheEmailMafia</div>
