      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="space-y-8 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">Pragya may i have a sexy photo of yours? 👀</h1>
            <p className="text-xl md:text-2xl text-gray-300 md:pd-[10px] pb-[30px]">Unlock Your Business Potential with Elite Email Marketing</p>
            {!isAuditRequested ? (
              !showAuditInput ? (
                <button
